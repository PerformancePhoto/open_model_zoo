...
def main():
    ...
    input_img = "/home/jtyo/data/moto_3/275609521_128539386398925_814015008834333472_n.jpg.jpg"
    model_xml = "/home/jtyo/Downloads/yolox_m_openvino/yolox_m.xml"
    model_at = "yolox"
    labels = "../../../data/dataset_classes/coco_80cl.txt"
    adapter = "openvino"
    ...
    plugin_config = get_user_config(device)
    model_adapter = OpenvinoAdapter(create_core(), model_xml, device=device, plugin_config=plugin_config,
                                    max_num_requests=num_infer_requests, model_parameters = {'input_layouts': None})
